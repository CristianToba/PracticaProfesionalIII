...
<html>
    ...
    <div class="panel-heading"> <b>Consultar Pais</b> </div>
      
    <FORM name ="formulario" METHOD="POST" action = "../GestorPPL/AltaPais.php" class="form-inline">
        <div class="panel-body">
            ...
            <div class="row-md-2" align="center" style="margin-top: 10px;">
                ...
                <input type="submit"  value="Guardar" class="btn btn-default" style="display:  none">
                <input type="button"  value="Cancelar" class="btn btn-default" style="display:  none">
