...
$sql = "SELECT T.idTurno, 
    ...
    T.baja,T.Habilitado, P.nombre as nombreMedico, P.apellido as apellidoMedico,E.especialidad,PE.nombre as nombrePaciente,PE.apellido as apellidoPaciente, PE.dni as dniPaciente
...
while ($row = sqlsrv_fetch_array($stmt)) {
    ...
    $agendaMedico[] = array('idTurno' => $idTurno, 'fechaTurno' => $fechaTurno,'nroTurno' => $nroturno, 'consultorio' => $consultorio,'clinicaNombre' => $clinicaNombre,'clinicaDir' => $clinicaDir , 
        ...
        'especialidadMed' => $especialidadMed, 'nombrePaciente' => $nombrePaciente, 'apellidoPaciente' => $apellidoPaciente, 'dniPaciente' => $dniPaciente);
